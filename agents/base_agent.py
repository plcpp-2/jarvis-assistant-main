...
class Agent:
    ...
    def update_metrics(self, success: bool, processing_time: float):
        ...
        self.metrics.success_rate = (self.metrics.success_rate * (self.metrics.tasks_completed - 1) + int(success)) / self.metrics.tasks_completed
        self.metrics.avg_processing_time = (self.metrics.avg_processing_time * (self.metrics.tasks_completed - 1) + processing_time) / self.metrics.tasks_completed
